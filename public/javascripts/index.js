...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("buttonAdd").addEventListener("click", function () {
    let newAppt = new ApptObject(document.getElementById("name").value, document.getElementById("email").value,
...
function createList() {
  ...
  apptArray.forEach(function (element, ) {   // use handy array forEach method
    ...
    li.innerHTML = "<a data-transition='pop' class='oneAppt' data-parm=" + element.Name + "  href='#detailPage'>Get Details </a> "  + element.Date + "  " + element.Time;
    ul.appendChild(li);
  });
